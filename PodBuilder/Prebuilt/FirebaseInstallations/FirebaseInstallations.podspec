Pod::Spec.new do |p1|
    p1.name             = 'FirebaseInstallations'
    p1.version          = '9.4.0'
    p1.summary          = 'Firebase Installations'
    ...
    p1.vendored_frameworks = 'FirebaseInstallations.xcframework'
    p1.frameworks = 'Security'

    p1.dependency 'FirebaseCore'
    p1.dependency 'GoogleUtilities/Environment'
    p1.dependency 'GoogleUtilities/UserDefaults'
