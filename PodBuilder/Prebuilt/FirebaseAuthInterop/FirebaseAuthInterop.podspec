Pod::Spec.new do |p1|
    p1.name             = 'FirebaseAuthInterop'
    p1.version          = '9.4.0'
    p1.summary          = 'Interfaces that allow other Firebase SDKs to use Auth functionality.'
    ...
    p1.vendored_frameworks = 'FirebaseAuthInterop.xcframework'
end